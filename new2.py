...
# ---------------- Rewards ----------------
rewards = []
reward_phase = 1   # 1 = small, 2 = medium, 3 = big
reward_config = {
    1: {
        "small": 5,
        "medium": 2,
...
def set_active_level(level_num):
    global level_1_active, level_2_active, level_3_active
...
def try_teleport():
    ...
    if (level_2_active or level_3_active) and in_minor_hazard_zone(player_x, player_y):
        return
